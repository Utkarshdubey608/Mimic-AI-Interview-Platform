...
const METADATA: Record<EmotionCategory, { label: string; color: string; Icon: LucideIcon; description: string }> = {
  positive_high: { label: 'Energy & Enthusiasm',  color: '#0F766E', Icon: Zap,           description: 'Excitement, pride, admiration' },
  positive_calm: { label: 'Calm & Contentment',   color: '#4338CA', Icon: Waves,         description: 'Serenity, satisfaction, awe' },
  ...
  disengagement: { label: 'Disengagement',        color: '#5B6067', Icon: MinusCircle,   description: 'Boredom, doubt, awkwardness' },
}
